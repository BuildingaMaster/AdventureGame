...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.EnabledCombo.setFont(font)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label.setText(QCoreApplication.translate("Dialog", u"Select attributes that apply in the room.", None))
        self.Common.setTitle(QCoreApplication.translate("Dialog", u"Common", None))
        self.Option8Check.setText(QCoreApplication.translate("Dialog", u"Armor 3", None))
        ...
        self.Option6Check.setText(QCoreApplication.translate("Dialog", u"Armor 1", None))
        self.Option5Check.setText(QCoreApplication.translate("Dialog", u"Boomerang in room", None))
        ...
        self.Option7Check.setText(QCoreApplication.translate("Dialog", u"Armor 2", None))
        ...
        self.EnabledCombo.setItemText(1, QCoreApplication.translate("Dialog", u"Princess in Room", None))
        self.EnabledCombo.setItemText(2, QCoreApplication.translate("Dialog", u"Dragon in Room", None))
        self.EnabledCombo.setItemText(3, QCoreApplication.translate("Dialog", u"The King in Room", None))
        self.EnabledCombo.setItemText(4, QCoreApplication.translate("Dialog", u"Potion of Strength", None))
        self.EnabledCombo.setItemText(5, QCoreApplication.translate("Dialog", u"Potion of Mobility", None))
        self.EnabledCombo.setItemText(6, QCoreApplication.translate("Dialog", u"Potion of Sobriety", None))
        self.EnabledCombo.setItemText(7, QCoreApplication.translate("Dialog", u"Potion of Teleportation", None))
        self.EnabledCombo.setItemText(8, QCoreApplication.translate("Dialog", u"Villager 1 in Room", None))
        self.EnabledCombo.setItemText(9, QCoreApplication.translate("Dialog", u"Villager 2 in Room", None))
        self.EnabledCombo.setItemText(10, QCoreApplication.translate("Dialog", u"Villager 3 in room", None))
        self.EnabledCombo.setItemText(11, QCoreApplication.translate("Dialog", u"Villager 4 in Room", None))
        self.EnabledCombo.setItemText(12, QCoreApplication.translate("Dialog", u"Villager 5 in room", None))
        self.EnabledCombo.setItemText(13, QCoreApplication.translate("Dialog", u"Villager 6 in Room", None))
