...
protected:
	...
	void backStory()
	{
		...
		cout << "But you cannot seem to make out who’s head has the price on it. " << endl;
		...
		cout << "Your quest is to get into castle and find out what happened to your great relationship with the princess and try to win her heart back." << endl;
	}
public:
	StartingRoom()
	{
